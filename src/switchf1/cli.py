...
def main():
    ...
    p.add_argument('--mode',choices=['boundary','boundary_exact','anchored'],default='boundary',help='boundary: insertion-aware (default); boundary_exact: exact positions; anchored: exact positions and words')
