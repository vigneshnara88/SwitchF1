...
def main():
    ...
    p.add_argument('--mode',choices=['boundary','boundary_v2','boundary_exact','anchored'],default='boundary',help='boundary: insertion/deletion-aware (default); boundary_v2: original endpoints; boundary_exact: exact positions; anchored: exact positions and words')
